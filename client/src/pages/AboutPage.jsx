...
const AboutPage = () => {
  ...
  const refreshToken = async () => {
    try {
      ...
      if (decoded.role === 1) { // Check if user is admin
        navigateTo('/admin'); // Redirect admin to admin page
      }
    } catch (error) {
      navigateTo('/login');
    }
        ...
        <Container>
          <Row>
            <Col>
              ...
              <p className="text-center mt-4 pt-4 px-5 animate__animated animate__fadeInUp">KeyLock hadir sebagai solusi bagi masyarakat untuk secara rutin memeriksa apakah email mereka terlibat dalam kasus kebocoran data. Kami juga menyediakan fitur-fitur untuk meningkatkan keamanan sebelum atau setelah terjadinya kebocoran data, khususnya terkait dengan penggunaan email. Dengan KeyLock, kami berharap dapat membantu masyarakat menghindari kasus kebocoran data di dunia maya, sehingga menciptakan lingkungan digital yang lebih aman dan lebih baik untuk Indonesia.</p>
            </Col>
          </Row>
          <Row>
...
const renderPrivacyPolicy = () => {
  return (
    <>
      ...
      <p className="mt-3 animate__animated animate__fadeInUp" style={{ marginBottom: '60px' }}>KeyLock menggunakan sumber terbuka dari <a href="https://haveibeenpwned.com/" style={{ textDecoration: 'none', color: '#071d28' }}>HaveIBeenPwned</a> untuk mendapatkan informasi mengenai kebocoran data. Untuk melakukan pemeriksaan kebocoran data Anda, kami memerlukan alamat email Anda. Kami tidak menyimpan informasi alamat email yang Anda masukkan.</p>
